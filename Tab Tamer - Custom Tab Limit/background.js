...
// when the broswer is first open, set appropriate values
getData(['maxTabs', "closingMode"], function(resultObj) {
    if (!resultObj.hasOwnProperty('maxTabs') && !resultObj.hasOwnProperty('closingMode')) {
        setData({"maxTabs": 15, "closingMode": "most recent"}, (msg) => console.log(msg));
    }
})
